package com.example.HospitalInsurancePackage.model;
...
public class DiseaseDetails {
	...
	public String toString() {
		return "DiseaseDetails [diseaseId=" + diseaseId + ", diseaseName=" + diseaseName + ", icdCode=" + icdCode
				+ ", diseaseDiscription=" + diseaseDiscription + ", diseaseStatus=" + diseaseStatus + "]";
	}
